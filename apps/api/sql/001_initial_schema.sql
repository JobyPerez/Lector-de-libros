CREATE TABLE users (
  ...
  deepgram_api_key_encrypted VARCHAR2(2000 CHAR),
  deepgram_tts_model VARCHAR2(100 CHAR),
  aws_region VARCHAR2(100 CHAR),
  aws_access_key_id_encrypted VARCHAR2(2000 CHAR),
  aws_secret_access_key_encrypted VARCHAR2(2000 CHAR),
